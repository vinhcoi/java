...
public class Main extends JFrame {
    ...
    private final int[] screenSizeXY = {400, 715};
    private final int[] carSizeXY = {20, 46};
    private final int[] bullestSizeXY = {5, 5};
    private final int[] gunSizeXY = {87, 27};
    ...
    private final int numberOfGuns = 5;
    ...
    class sprit extends JPanel {
        ...
        protected void paintComponent(Graphics g) {
            ...
            for (int i = 0; i < guns.length; i++) {
                ...
                if (debugEnabled) {
                    g.fillRect(x, y, gunSizeXY[0], gunSizeXY[1]);
                }
